...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '566a3682-6fd7-4f78-98b7-5405f8b5050b' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('c6a23cee-4804-4f64-b980-2c1cd6cf21a0');
      cy.get(`[data-cy="name"]`).should('have.value', 'c6a23cee-4804-4f64-b980-2c1cd6cf21a0');
