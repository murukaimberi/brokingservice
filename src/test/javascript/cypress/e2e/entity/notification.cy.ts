...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    message: 'or',
    notificationDate: '2024-06-06T13:21:00.108Z',
    dueDate: '2024-06-06T19:48:17.113Z',
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="message"]`).type('psst hunt');
      cy.get(`[data-cy="message"]`).should('have.value', 'psst hunt');

      cy.get(`[data-cy="notificationDate"]`).type('2024-06-07T08:33');
      cy.get(`[data-cy="notificationDate"]`).blur();
      cy.get(`[data-cy="notificationDate"]`).should('have.value', '2024-06-07T08:33');

      cy.get(`[data-cy="dueDate"]`).type('2024-06-06T14:10');
      cy.get(`[data-cy="dueDate"]`).blur();
      cy.get(`[data-cy="dueDate"]`).should('have.value', '2024-06-06T14:10');

      cy.get(`[data-cy="notificationStatus"]`).select('DONE');
