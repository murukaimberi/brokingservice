...
import static za.co.afrikatek.brokingservice.domain.CountryAsserts.*;
...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().name(DEFAULT_NAME).currency(DEFAULT_CURRENCY).currencyCode(DEFAULT_CURRENCY_CODE);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().name(UPDATED_NAME).currency(UPDATED_CURRENCY).currencyCode(UPDATED_CURRENCY_CODE);
        return country;
    }
    ...
    void putExistingCountry() throws Exception {
        ...
        updatedCountry.name(UPDATED_NAME).currency(UPDATED_CURRENCY).currencyCode(UPDATED_CURRENCY_CODE);
    ...
    void fullUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.name(UPDATED_NAME).currency(UPDATED_CURRENCY).currencyCode(UPDATED_CURRENCY_CODE);
