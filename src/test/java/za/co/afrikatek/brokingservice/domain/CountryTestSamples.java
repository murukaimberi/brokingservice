...
public class CountryTestSamples {
    ...
    public static Country getCountrySample1() {
        return new Country().id(1L).name("name1").currency("currency1").currencyCode("currencyCode1");
    }

    public static Country getCountrySample2() {
        return new Country().id(2L).name("name2").currency("currency2").currencyCode("currencyCode2");
    }
