...
import { sampleWithRequiredData } from '../insurance-type.test-samples';
...
describe('InsuranceType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, InsuranceTypeComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.insuranceTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to insuranceTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getInsuranceTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getInsuranceTypeIdentifier).toHaveBeenCalledWith(entity);
