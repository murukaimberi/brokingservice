...
describe('BusinessPartner Management Detail Component', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [BusinessPartnerDetailComponent],
      providers: [
        provideRouter(
          [
            {
              ...
              resolve: { businessPartner: () => of({ id: 123 }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load businessPartner on init', async () => {
      const harness = await RouterTestingHarness.create();
      const instance = await harness.navigateByUrl('/', BusinessPartnerDetailComponent);

      // THEN
      expect(instance.businessPartner()).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
