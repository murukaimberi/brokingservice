...
import { sampleWithRequiredData } from '../contract-history.test-samples';
...
describe('ContractHistory Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ContractHistoryComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.contractHistories?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to contractHistoryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getContractHistoryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getContractHistoryIdentifier).toHaveBeenCalledWith(entity);
